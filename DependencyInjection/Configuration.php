        ...
        $treeBuilder
            ...
            ->beforeNormalization()
                ...
                ->then(function ($v) {
                    $v['areas'] = $v['routes'];
                    unset($v['routes']);
                    @trigger_error('The `sredbull_api_doc.routes` config option is deprecated. Please use `sredbull_api_doc.areas` instead (just replace `routes` by `areas` in your config).', E_USER_DEPRECATED);
            ...
            ->beforeNormalization()
                ...
                ->thenInvalid('You must not use both `sredbull_api_doc.areas` and `sredbull_api_doc.routes` config options. Please update your config to only use `sredbull_api_doc.areas`.')
            ->end()
            ->children()
                ...
                ->arrayNode('areas')
                    ...
                    ->validate()
                        ...
                        ->thenInvalid('You must specify a `default` area under `sredbull_api_doc.areas`.')
                    ->end()
